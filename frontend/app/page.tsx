...
// Next-Level Asset: Neural Mesh Background
function NeuralMesh() {
  return (
...
// Next-Level Asset: Animated Sparkline
...
// 10/10 Asset: Probabilistic Risk SVG (Adapted for Dark Theme)
function RiskTrajectorySVG({ pathProgress }: { pathProgress: any }) {
  // Map markers to specific scroll progress points
...
export default function LandingPage() {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-[#0a0f0e] text-slate-200 selection:bg-teal-500/30 selection:text-teal-200 overflow-x-hidden font-sans">
      ...
      <nav className="fixed top-8 left-1/2 -translate-x-1/2 w-full max-w-5xl z-50 px-6">
        <div className="h-14 bg-white/[0.03] backdrop-blur-3xl border border-white/10 rounded-full px-4 md:px-8 flex justify-between items-center shadow-[0_0_50px_rgba(0,0,0,0.5)]">
          <div className="flex items-center gap-12">
            <Link href="/" className="flex items-center gap-3 font-black text-white group">
              <div className="size-8 bg-teal-500/10 rounded-lg flex items-center justify-center border border-teal-500/20 group-hover:scale-110 group-hover:bg-teal-500/30 transition-all duration-500 shadow-[0_0_15px_rgba(43,212,189,0.1)]">
                <Activity className="h-4 w-4 text-[#2bd4bd] group-hover:rotate-[360deg] transition-all duration-700" />
              </div>
              <span className="text-xl tracking-tighter group-hover:text-[#2bd4bd] transition-colors">CliniqueAI</span>
            </Link>
          ...
          <div className="flex items-center gap-6">
            <Magnetic><Link href="/login" className="hidden sm:block text-[10px] font-black uppercase tracking-[0.3em] text-white/40 px-4 hover:text-[#2bd4bd] hover:drop-shadow-[0_0_10px_rgba(43,212,189,0.4)] transition-all">Sign In</Link></Magnetic>
            <Link href="/register">
              <Button className="shimmer glow-btn bg-[#2bd4bd] hover:bg-[#2bd4bd]/90 text-[#0a0f0e] font-black h-9 px-6 rounded-xl transition-all text-[10px] uppercase tracking-widest shadow-[0_0_20px_rgba(43,212,189,0.4)] border-none">
                Launch Suite
              </Button>
            </Link>
          </div>
      ...
      {/* --- Hero --- */}
      <section className="relative pt-36 pb-16 flex flex-col items-center z-10">
        {/* Floating UI Badges */}
        <motion.div
      ...
      <section id="showcase" className="py-32 px-6 overflow-hidden bg-white/5 relative z-10">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-28">
            <h2 className="text-5xl md:text-7xl font-black text-white tracking-[-0.05em] italic mb-4">The Command Centers.</h2>
            <p className="text-slate-500 font-bold text-lg tracking-tight">Visualizing the intersection of artificial intelligence and human clinical expertise.</p>
          </div>
          ...
          <div className="relative h-[600px] flex items-center justify-center">
            ...
            >
              <div className="bg-[#0a0f0e]/95 backdrop-blur-3xl border border-teal-500/40 rounded-[2.5rem] shadow-[0_0_80px_rgba(43,212,189,0.15)] p-10 space-y-10 group hover:border-teal-400 transition-all">
                <div className="flex justify-between items-start">
                  <div>
                    <div className="text-[10px] text-slate-500 uppercase tracking-widest font-bold mb-1">Composite Health Matrix</div>
                    <div className="text-6xl font-black text-white tracking-tighter">92<span className="text-[#2bd4bd]">.4</span></div>
                  </div>
                  <div className="size-16 rounded-full bg-teal-500/20 flex items-center justify-center text-[#2bd4bd] shadow-inner">
      ...
      <section id="product" ref={riskSectionRef} className="py-64 max-w-7xl mx-auto px-6">
        <div className="text-center mb-36">
          <p className="text-[11px] font-black text-[#2bd4bd] uppercase tracking-[0.6em] mb-8">Probability & Uncertainty</p>
          <h2 className="text-6xl md:text-[120px] font-black text-white tracking-[-0.06em] leading-none mb-4 lowercase">risk_trajectory.</h2>
        </div>

        <SpotlightCard className="md:col-span-12 min-h-[600px] flex flex-col justify-between overflow-hidden">
          <div className="flex justify-between items-start mb-12">
            <div className="space-y-2">
              <h3 className="text-4xl font-black text-white">The Probabilistic Core.</h3>
              <p className="text-slate-500 font-medium max-w-lg">Transforming routine structured data into health estimates with explicit ±uncertainty boundaries.</p>
            </div>
            <div className="bg-teal-500/10 px-6 py-2 rounded-full border border-teal-500/20 flex items-center gap-3">
              <div className="size-2 rounded-full bg-teal-500 animate-pulse" />
              <span className="text-[10px] font-black text-teal-400 uppercase tracking-widest font-mono">Real-time Inference</span>
            </div>
          </div>
          <div className="flex-1 bg-[#0a0f0e]/50 rounded-[2.5rem] border border-white/5 shadow-inner p-4 md:p-12 relative min-h-[400px]">
            <RiskTrajectorySVG pathProgress={pathProgress} />
            <div className="absolute bottom-12 right-12 text-right">
              <p className="text-[10px] font-bold text-slate-600 uppercase mb-2">Confidence Level</p>
              <p className="text-4xl font-black text-white">0.96</p>
              <p className="text-[9px] font-bold text-teal-500 uppercase">Validated_OPD</p>
            </div>
          </div>
        </SpotlightCard>
      </section>
      ...
      <section id="impact" className="py-40 bg-[#0a0f0e]">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-32">
          <div className="sticky top-64 self-start space-y-12">
            <div className="size-16 bg-teal-500 rounded-3xl flex items-center justify-center shadow-[0_0_40px_rgba(43,212,189,0.4)]">
              <ShieldAlert className="h-8 w-8 text-[#0a0f0e]" />
            </div>
            <h2 className="text-6xl lg:text-[80px] font-black text-white tracking-[-0.05em] leading-[0.8] mb-8">PS-1: <br /> Preventive <br /> Decision Core.</h2>
            <p className="text-xl text-slate-500 font-bold leading-relaxed max-w-sm tracking-tight">The Praxis 2.0 Challenge: Transforming noisy routine data into definitive clinical intervention.</p>
          </div>
          ...
          <div className="space-y-40 pb-40">
            {[
              ...
              <motion.div key={i} initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 1 }} className="group">
                <span className="text-[10px] font-black text-[#2bd4bd] uppercase tracking-[0.4em] mb-8 block">{step.time}</span>
                <div className={`border-l-4 ${step.col} pl-12 space-y-6 group-hover:pl-16 transition-all`}>
                  ...
                  <div className="flex items-center gap-4 py-4"><div className="size-10 bg-white/5 rounded-full flex items-center justify-center border border-white/10 grayscale"><step.icon className="h-5 w-5" /></div> <span className="text-[9px] font-bold text-slate-600 uppercase">HACKATHON_SPEC_v4.0_PS1</span></div>
                </div>
              </motion.div>
            ))}
          </div>
      ...
      <section className="py-32 max-w-7xl mx-auto px-6 border-t border-white/5">
        <div className="flex flex-col md:flex-row justify-between items-end gap-12 mb-24">
          <div className="max-w-xl space-y-6">
            <h2 className="text-5xl md:text-7xl font-black text-white tracking-[-0.05em] leading-tight">PS-1 Engine.</h2>
            <p className="text-slate-500 font-bold text-lg tracking-tight leading-relaxed">Engineered for high-fidelity preventive risk modeling and scalable biomarker ingestion. Built for PS-1 performance benchmarks.</p>
          </div>
          <div className="px-6 py-4 bg-white/5 rounded-2xl border border-white/10 flex items-center gap-4 group cursor-pointer hover:border-teal-500/30 transition-colors">
            <ShieldCheck className="h-6 w-6 text-[#2bd4bd] group-hover:scale-110 transition-transform" /> <span className="text-xs font-black uppercase tracking-widest text-[#2bd4bd]">PRAXIS 2.0_PS1 READY</span>
          </div>
        </div>
        ...
        <div className="mt-32 grid grid-cols-2 md:grid-cols-4 gap-12 pt-24 border-t border-white/5">
          {[
            ...
            <div key={i} className="text-center">
              <div className="text-5xl lg:text-7xl font-black text-white italic mb-2 tracking-[-0.08em]">{stat.val}</div>
              <div className="text-[10px] font-black text-slate-600 uppercase tracking-[0.3em]">{stat.lbl}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      {/* --- CTA --- */}
      <section className="py-60 px-6 relative flex flex-col items-center justify-center overflow-hidden">
        <div className="absolute w-[800px] h-[800px] bg-teal-500/10 blur-[150px] rounded-full z-0" />
        <div className="relative z-10 p-24 md:p-32 rounded-[4rem] bg-white/[0.02] backdrop-blur-3xl border border-teal-500/20 text-center max-w-5xl shadow-2xl hover:border-teal-400 transition-all">
          ...
          <h2 className="text-6xl md:text-[100px] font-black text-white leading-[0.85] mb-12 tracking-[-0.06em] italic">Ready for the <br /> <span className="text-[#2bd4bd]">Preventive Era?</span></h2>
          <p className="text-2xl text-slate-400/90 font-bold max-w-2xl mx-auto mb-16 tracking-tight">Join 500+ clinical hubs worldwide redefining medical forecasting with CliniqueAI.</p>
          <div className="flex flex-col sm:flex-row gap-12 justify-center items-center">
            <Magnetic>
              <Link href="/register">
                <Button className="shimmer h-20 px-16 text-sm font-black uppercase tracking-[0.3em] bg-gradient-to-r from-teal-400 to-teal-500 hover:to-teal-600 text-[#0a0f0e] rounded-2xl shadow-[0_0_50px_rgba(43,212,189,0.4)] transition-all glow-btn border-none">
                  Execute Onboarding
                </Button>
              </Link>
            </Magnetic>
            <Magnetic>
              <Link href="/specialist" className="flex items-center gap-4 text-xs font-bold tracking-[0.4em] text-slate-500 py-4 uppercase hover:text-white hover:drop-shadow-[0_0_10px_rgba(43,212,189,0.5)] transition-all group">
                Talk to a Specialist <ArrowRight className="h-4 w-4 group-hover:translate-x-2 transition-transform" />
              </Link>
            </Magnetic>
          </div>
        </div>
